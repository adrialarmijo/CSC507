# This script contains code to call the sorting problem of bin-packing.py, but this is not relevant for
# the final portfolio submission. 
# It was used in other course assignments and is kept here for personal future reference.
...
def split_by_chunk_size(file_name, chunks, exercise_num): # bin-packing
